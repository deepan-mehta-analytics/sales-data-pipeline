...
#
# Tests cover:
#   - Successful CSV ingestion from a valid file
#   - Correct dtype enforcement (Postal Code stays str, Sales is float64)
#   - FileNotFoundError raised for a missing source file
